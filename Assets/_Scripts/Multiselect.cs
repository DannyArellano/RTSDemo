...
public static class Multiselect
{
    ...
    public static void DrawScreenRectBorder(Rect rect, float thicc, Color color){
        DrawScreenRect(new Rect(rect.xMin, rect.yMin, rect.width, thicc), color);
        DrawScreenRect(new Rect(rect.xMin, rect.yMax-thicc, rect.width, thicc), color);
        DrawScreenRect(new Rect(rect.xMin, rect.yMin, thicc, rect.height), color);
        DrawScreenRect(new Rect(rect.xMax - thicc, rect.yMin, thicc, rect.height), color);
    }
